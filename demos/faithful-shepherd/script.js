/* =============================================================
   The Faithful Shepherd Apparel Company — storefront mockup logic
...
(function () {
  ...
  function renderProducts() {
    grid.innerHTML = PRODUCTS.map(function (p) {
      return (
        '<article class="card">' +
        '<div class="product-media" data-art="' +
        p.art +
        '" role="img" aria-label="' +
        escapeHtml(p.name) +
  ...
  function openCart() {
    ...
    // allow the element to render before transitioning
  ...
  /* ---------- Smooth-scroll for hero CTA / in-page anchors ---------- */
